"""
Generate a professional course PPTX for Maps Lead Scraper.
...
def footer_text(slide, text="Maps Lead Scraper Course"):
...
add_text_box(slide, Inches(1), Inches(1.8), Inches(11), Inches(1.2),
             "Google Maps Lead Scraper", font_size=44, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
...
modules = [
    ...
    ("Module 2", "Maps Lead Scraper Walkthrough", "Install extension, run first scrape, export CSV"),
...
tools = [
    ...
    ("Chrome", "Browser + extensions", "google.com/chrome", "Run Maps Lead Scraper"),
]
...
steps = [
    ...
    "7. Install Maps Lead Scraper extension in Chrome",
    "",
...
add_text_box(slide, Inches(1.3), Inches(0.25), Inches(8), Inches(0.7),
             "Module 2: Maps Lead Scraper Walkthrough", font_size=30, color=WHITE, bold=True)
...
demo_steps = [
    "1. Open Chrome > Click Maps Lead Scraper extension icon",
...
resources = [
    ...
    "Maps Lead Scraper Extension - Chrome extension with free credits",
]
...
#  SAVE
# ═══════════════════════════════════════════════════════
output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Maps_Lead_Scraper_Course.pptx')
